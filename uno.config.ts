...
export default defineConfig({
  ...
  theme: {
    ...
    fontFamily: {
      // All UI roles use Geist for a modern technical brand (no literary serif)
      sans: sansStack,
      title: sansStack,
      navbar: sansStack,
      time: sansStack,
  ...
  shortcuts: {
    ...
    'uno-decorative-line': 'mb-4.5 h-px w-10 bg-secondary/20 lg:(mb-6 w-11)',
    'uno-round-border': 'border border-secondary/10 rounded-lg border-solid',
    'uno-card': 'border border-secondary/10 rounded-lg border-solid bg-secondary/2 transition-colors duration-150 hover:border-secondary/20',
  },
  variants: [
    (matcher) => {
